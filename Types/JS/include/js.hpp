    ...
    namespace Type
    {
        namespace JS
        {
            namespace TokenType
            {
                ...
                constexpr uint32 Keyword_String = 6000;
                constexpr uint32 Keyword_Number = 6001;
                constexpr uint32 Keyword_Void = 6002;
                constexpr uint32 Keyword_Let = 6003;
                constexpr uint32 Keyword_Byte = 6004;
                constexpr uint32 Keyword_Boolean = 6005;
                constexpr uint32 Keyword_Var = 6006;
                constexpr uint32 Keyword_Int = 6007;
                constexpr uint32 Keyword_Float = 6008;
                constexpr uint32 Keyword_Char = 6009;
                constexpr uint32 Keyword_Object = 6010;
                constexpr uint32 Keyword_Short = 6011;
                constexpr uint32 Keyword_Long = 6012;

                constexpr uint32 Keyword_False = 8000;
                constexpr uint32 Keyword_Nan = 8001;
