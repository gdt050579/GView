...
std::unordered_map<std::u16string_view, StringMemberAccessCallFn> constStringMemberAccessCall{ { u"charCodeAt", EvalStringCharCodeAt },
    ...
    AST::Action ConstFolder::OnEnterBinop(AST::Binop* node, AST::Expr*& replacement)
    {
        return FoldBinop(node, replacement);
    }

    AST::Action ConstFolder::OnExitBinop(AST::Binop* node, AST::Expr*& replacement)
    {
        return FoldBinop(node, replacement);
    }

    AST::Action ConstFolder::OnExitMemberAccess(AST::MemberAccess* node, AST::Expr*& replacement)
    {
        auto obj = node->obj;
    ...
    AST::Action ConstFolder::OnExitCall(AST::Call* node, AST::Expr*& replacement)
    {
    ...
    AST::Expr* ConstFolder::Fold(AST::Number* left, AST::Number* right, uint32 op)
    {
    ...
    AST::Expr* ConstFolder::Fold(AST::Number* left, AST::String* right, uint32 op)
    {
        auto leftVal  = left->value;
        auto rightVal = right->value;
    ...
    AST::Expr* ConstFolder::Fold(AST::String* left, AST::Number* right, uint32 op)
    {
        auto leftVal  = left->value;
        auto rightVal = right->value;
    ...
    AST::Expr* ConstFolder::Fold(AST::String* left, AST::String* right, uint32 op)
    {
        auto leftVal  = left->value;
        auto rightVal = right->value;
    ...
    AST::Expr* ConstFolder::Fold(AST::Constant* left, AST::Constant* right, uint32 op)
    {
    ...
    AST::Action ConstFolder::FoldBinop(AST::Binop* node, AST::Expr*& replacement)
    {
        auto left = node->left;
