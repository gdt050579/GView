...
using namespace GView::Type::VBA;
using namespace AppCUI::Controls;

Panels::Information::Information(Reference<GView::Type::VBA::VBAFile> _vba) : TabPage("&Information")
{
    vba    = _vba;
...
void Panels::Information::UpdateGeneralInformation()
{
    ...
    general->AddItem(
          { "Size",
            tempStr.Format("%s bytes", n.ToString(vba->obj->GetData().GetSize(), { NumericFormatFlags::None, 10, 3, ',' }).data()) });
}
