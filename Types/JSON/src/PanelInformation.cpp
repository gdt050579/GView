...
using namespace GView::Type::JSON;
using namespace AppCUI::Controls;

Panels::Information::Information(Reference<GView::Type::JSON::JSONFile> _json) : TabPage("&Information")
{
    json    = _json;
...
void Panels::Information::UpdateGeneralInformation()
{
    ...
    general->AddItem(
          { "Size",
            tempStr.Format("%s bytes", n.ToString(json->obj->GetData().GetSize(), { NumericFormatFlags::None, 10, 3, ',' }).data()) });
}
