...
using namespace GView::Type::CPP;
using namespace AppCUI::Controls;

Panels::Information::Information(Reference<GView::Type::CPP::CPPFile> _cpp) : TabPage("&Information")
{
    cpp     = _cpp;
...
void Panels::Information::UpdateGeneralInformation()
{
    ...
    general->AddItem(
          { "Size",
            tempStr.Format("%s bytes", n.ToString(cpp->obj->GetData().GetSize(), { NumericFormatFlags::None, 10, 3, ',' }).data()) });
