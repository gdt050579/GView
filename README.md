...
| PDF | PDF (Portable Document Format) files - the ISO standard for electronic documents containing text, images, and embedded objects | Parse and view PDFs; show binary, structural, and text layers; extract text; list objects/streams; flag JavaScript, embedded files, and other potential IOCs |
